...
/* This interface defines a single element for syntetic record data generation.
   When called, it returns a string representing the value for a single field
   in a single record. Implementers use the Factory pattern to define how fields
   get generated. */
public interface DataElementInterface
{
    // Return the next piece of data for whatever field this represents
